...
public class BrowserFactory {
    ...
    //Pe baza acestor valori vom lua o decizie in functie de enviormentul pe care se ruleaza testele automate
    ...
    public WebDriver getBrowserDriver(){
        ...
        //Daca este pe remote trenuie sa citeassca valoarea din pom.xml
        //Daca este pe local trb sa citeasca val din BrowserData.Propriety
        if (cicd){
